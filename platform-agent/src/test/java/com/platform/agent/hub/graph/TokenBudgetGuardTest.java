...
/**
 * Unit tests for TokenBudgetGuard. Verifies budget enforcement contract: hard-limit blocks,
 * soft-limit warns, no-record allows.
 */
...
class TokenBudgetGuardTest {
  ...
  private AgentTokenBudget makeBudget(
      boolean hardLimit, long usedInput, long usedOutput, String usedCostCents) {
  ...
  private AgentTokenBudget makeBudgetByTokens(
      boolean hardLimit,
      long usedInput,
      long maxInput,
      long usedOutput,
