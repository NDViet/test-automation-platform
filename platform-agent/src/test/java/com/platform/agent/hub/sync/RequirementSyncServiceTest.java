...
class RequirementSyncServiceTest {
  ...
  void setUp() {
    ...
    service =
        new RequirementSyncService(
            requirementRepo, configRepo, rulesProvider, new MappingProfileApplier(), om);
  ...
  private ProjectIntegrationConfig config(String type, Map<String, String> params) {
    ProjectIntegrationConfig c =
        new ProjectIntegrationConfig(projectId, "REQUIREMENT", type, "disp", "INBOUND");
