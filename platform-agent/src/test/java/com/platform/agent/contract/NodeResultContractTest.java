...
/**
 * Verifies the NodeResult factory contract: correct status flags, non-null invariants, and token
 * accounting.
 */
  ...
  void completed_hasCorrectStatus() {
    NodeResult result =
        NodeResult.completed(
            ...
            wid,
            NodeType.TEST_GEN,
            AgentTaskType.GENERATE_AUTOMATED_TESTS,
  ...
  void failed_hasCorrectStatus() {
    NodeResult result =
        NodeResult.failed(
            ...
            wid,
            NodeType.HEALING,
            AgentTaskType.PROPOSE_HEAL_FIX,
            "MISSING_API_KEY",
