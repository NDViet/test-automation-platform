 ...
 *
 * GET  /hub/impact/{projectId}        — list all analyses for a project
 * GET  /hub/impact/{projectId}/prs    — list open PRs from CODEBASE GitHub repos
 * POST /hub/impact/{projectId}        — create analysis + trigger async AI run
 * GET  /hub/impact/{projectId}/{id}   — get a specific analysis
 */
@RestController
...
public class ImpactAnalysisController {
    ...
    public ImpactAnalysisController(ImpactAnalysisRepository impactRepo,
    ...
    public ResponseEntity<ImpactAnalysis> get(
            @PathVariable UUID projectId,
            @PathVariable UUID id) {
        return impactRepo.findById(id)
    ...
    public record CreateImpactAnalysisRequest(
            String name,
            List<LinkedPrRef> linkedPrs,
            List<String> linkedRequirementIds) {}

    public record LinkedPrRef(
            String repoFullName,
            int prNumber,
            String prUrl,
            String prTitle) {}
