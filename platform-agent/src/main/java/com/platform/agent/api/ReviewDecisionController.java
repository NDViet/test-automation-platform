...
public class ReviewDecisionController {
    ...
    public ReviewDecisionController(ReviewGateway reviewGateway,
    ...
    public ResponseEntity<Void> decide(@PathVariable UUID reviewRequestId,
    ...
    public ResponseEntity<?> get(@PathVariable UUID reviewRequestId) {
        return reviewRepo.findById(reviewRequestId)
