...
public class AdoStructureSyncController {
    ...
    public AdoStructureSyncController(AzureOrgSyncService orgSyncService,
                                     WorkItemHistorySyncService historySyncService) {
    ...
    public ResponseEntity<Map<String, Object>> syncStructure(@PathVariable UUID projectId) {
        try {
            ...
            return ResponseEntity.ok(Map.of(
                    "success", true,
                    "teams", r.teams(), "areas", r.areas(),
                    "iterations", r.iterations(), "users", r.users()));
    ...
    public ResponseEntity<Map<String, Object>> syncHistory(@PathVariable UUID projectId,
