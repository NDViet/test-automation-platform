...
/**
 * On-demand GitHub sync endpoint for projects using PAT + polling instead of webhooks.
 * Useful for CI pipelines or UI "Sync now" buttons that can't wait for the next poll interval.
 *
 * POST /hub/integrations/github/{projectId}/sync
 *   Immediately polls GitHub for new/updated PRs and triggers analysis workflows.
 *   Returns 200 with {"triggered": N}.
 */
@RestController
