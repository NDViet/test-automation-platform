 ...
 *
 * <p>Security is a shared secret in the query parameter:
 * {@code POST /hub/webhooks/github-issues?secret={token}}. (For production,
 * prefer validating the {@code X-Hub-Signature-256} HMAC header.)</p>
 */
@RestController
...
public class GitHubIssuesWebhookController {
    ...
    public GitHubIssuesWebhookController(ObjectMapper mapper,
    ...
    public ResponseEntity<Void> handle(
        ...
        try {
            ...
            TriggerRef trigger = new TriggerRef(
                    ...
                    "issue", repo + "#" + number, url, actor, Instant.now());

            log.info("GitHub Issues webhook: {} for {}#{} — triggering workflow for project {}",
                    action, repo, number, projectId);
