...
/**
 * Hub component that tracks registered Node instances and their capabilities.
 * Nodes register on startup via POST /hub/nodes/register and heartbeat every 30s.
 */
