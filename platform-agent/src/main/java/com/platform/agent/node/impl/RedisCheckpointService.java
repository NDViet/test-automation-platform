...
/**
 * Redis-backed CheckpointService.
 * PROMPT_CACHE / COMPRESSED: stored in Redis with TTL.
 * HANDOFF: stored in Redis with longer TTL (and optionally persisted to PostgreSQL by a scheduled job).
 */
@Component
