...
class JiraIssueMapperTest {
  ...
  void createBodyContainsRequiredFields() throws Exception {
    IssueRequest req =
        new IssueRequest(
            "Test failure: loginTest",
            "Test failed 3 times",
            "Bug",
            "High",
            "PROJ",
            List.of("platform-auto"),
  ...
  void createBodyHasLabels() throws Exception {
    IssueRequest req =
        new IssueRequest(
            "Title", "Desc", "Bug", null, "PROJ", List.of("label1", "label2"), "test", "team");
  ...
  void labelIsSanitized() throws Exception {
    IssueRequest req =
        new IssueRequest(
            "Title", "Desc", "Bug", null, "PROJ", List.of("com.example.Test#method"), "t", "team");
  ...
  void noPriorityFieldWhenNull() throws Exception {
    IssueRequest req =
        new IssueRequest("Title", "Desc", "Task", null, "PROJ", List.of(), "test", "team");
