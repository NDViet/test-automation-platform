 ...
 *
 * <p>One instance is created per {@code IntegrationConfig} row — not a Spring bean. Instantiated by
 * {@link JiraTrackerFactory}.
 */
public class JiraIssueTracker implements IssueTrackerPort {
  ...
  public JiraIssueTracker(
      ...
      String projectKey,
      String doneTransitionName,
      String reopenTransitionName,
      String baseUrl) {
    this.client = client;
    this.mapper = mapper;
