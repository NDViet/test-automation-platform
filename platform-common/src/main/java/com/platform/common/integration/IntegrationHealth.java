...
/**
 * Health status of one integration connection, returned by
 * {@link IntegrationAdapter#checkHealth} and stored denormalized in
 * {@code integration_configs.health}.
 */
public record IntegrationHealth(
    ...
    public enum Status { HEALTHY, DEGRADED, DOWN, UNCONFIGURED }
