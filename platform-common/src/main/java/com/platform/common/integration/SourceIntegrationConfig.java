...
/**
 * Lightweight DTO for an integration connection.
 * Used in ContextBundle and IntegrationAdapter calls — not the JPA entity.
 * The full entity ({@code IntegrationConfigEntity}) lives in platform-core.
 */
