...
/**
 * Scoped, short-lived credentials passed from Hub to Node. Never persisted — assembled per session
 * from the secrets store. Keys are IntegrationType names (e.g. "GITHUB", "JIRA_CLOUD").
 */
public record SessionCredentials(
  ...
  public String toString() {
    return "SessionCredentials[count=" + tokens.size() + ", expired=" + isExpired() + "]";
  }
}
