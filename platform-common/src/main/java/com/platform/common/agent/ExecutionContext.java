...
/**
 * Recent execution context for the Hub→Node contract. Provides pass-rate trends, flakiness scores,
 * and failure details for healing.
 */
public record ExecutionContext(
  ...
  public boolean isFlaky() {
    return flakinessScore >= 0.30;
  }

  public boolean isCriticallyFlaky() {
    return flakinessScore >= 0.60;
  }
