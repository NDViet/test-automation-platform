...
/**
 * The primary Hub→Node contract. Assembles all five-tier context sections into one immutable
 * payload. Hub builds this; Nodes receive it and never modify it.
 */
public record ContextBundle(
  ...
  public boolean hasRequirements() {
    return requirementContext != null;
  }
