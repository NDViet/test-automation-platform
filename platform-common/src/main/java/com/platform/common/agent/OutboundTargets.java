...
/**
 * Where nodes should push their artifacts.
 * All fields are optional — null means "no target configured for this artifact type".
 */
public record OutboundTargets(
    ...
    public record ReviewTarget(
            ...
            String destination          // Slack channel, GitHub repo, portal project ID
    ) {}
