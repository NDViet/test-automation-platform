...
/**
 * Test case context for the Hub→Node contract. Carries existing TCs with their health status,
 * candidates for reuse, uncovered ACs that need new tests, and a human-authored style reference.
 */
public record TestCaseContext(
  ...
  public boolean hasCoverageGaps() {
    return !uncoveredAcRefs.isEmpty();
  }

  public boolean hasObsolete() {
    return totalObsolete > 0;
  }
}
