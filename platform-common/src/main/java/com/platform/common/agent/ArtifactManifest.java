...
/**
 * All artifacts produced in a session, returned in NodeResult.
 * Nodes report this to the Hub; the Hub routes each artifact to ReviewGateway.
 */
public record ArtifactManifest(List<ArtifactRef> artifacts) {
    ...
    public static ArtifactManifest empty() { return new ArtifactManifest(List.of()); }
