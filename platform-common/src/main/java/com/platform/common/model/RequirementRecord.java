...
/**
 * Platform-canonical representation of a requirement, regardless of
 * which external system it came from. Immutable value object used in
 * ContextBundle and traceability graph traversals.
 */
public record RequirementRecord(
    ...
    public enum IssueType {
        EPIC, STORY, TASK, SUBTASK, DEFECT, SPIKE
    }
}
