...
/**
 * A single named step within a test case. Steps are captured by the platform-testframework and flow
 * through to the AI classifier and dashboards, giving detailed per-action debugging context.
 */
