 ...
 *
 * <p>All time values are in <strong>milliseconds</strong>. Null fields mean the metric was not
 * available in the source report.
 *
 * <p>Carried through the pipeline in {@link UnifiedTestResult#performanceMetrics()} and persisted
 * to the {@code performance_metrics} table.
 */
