...
/**
 * Normalized test result schema — the common currency of the platform. Every parser (JUnit XML,
 * Cucumber, TestNG, Allure, Playwright, Newman) produces this record. All downstream services
 * consume this record.
 *
 * <p>Routing fields follow the ADO-first hierarchy: <b>teamId</b> = Organisation slug,
 * <b>projectId</b> = Project slug, <b>teamSlug</b> = optional Team slug to attribute results to a
 * specific team.
 */
