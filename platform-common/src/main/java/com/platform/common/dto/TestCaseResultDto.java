 ...
 *
 * <p>All parsers (JUnit XML, Cucumber, TestNG, Allure, Playwright, Newman) and the
 * platform-testframework produce this record. Use {@link #basic} for parser-generated results (no
 * step/trace data); use the canonical constructor when publishing from the test framework with full
 * debugging context.
 */
public record TestCaseResultDto(
  ...
  /**
   * Factory for parser-produced results — no step/trace data. All existing parsers (JUnit XML,
   * Cucumber, TestNG, Allure, Playwright, Newman) should use this instead of the canonical
   * constructor.
   */
