...
/**
 * High-level test category — distinguishes functional (correctness) tests from non-functional
 * (performance, security, accessibility) tests.
 *
 * <p>Inferred automatically from {@link SourceFormat}:
 *
 * <ul>
 *   <li>K6, GATLING, JMETER → {@code PERFORMANCE}
 *   <li>All others → {@code FUNCTIONAL}
 * </ul>
 *
...
public enum TestType {
  /**
   * Unit, integration, E2E, API contract tests. Default for
   * JUnit/Cucumber/TestNG/Playwright/Newman/Allure.
   */
  FUNCTIONAL,
