...
/**
 * BlobStore implementation backed by any S3-compatible object store.
 * Tested with MinIO (self-hosted) and AWS S3.
 * Works with GCS via its XML API interoperability endpoint.
 *
 * Storage is content-addressed: SHA-256(content) determines the key,
 * so identical content is stored exactly once across the entire platform.
 */
