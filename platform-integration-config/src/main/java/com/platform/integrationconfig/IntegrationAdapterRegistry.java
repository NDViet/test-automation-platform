...
/**
 * Spring-managed registry of all IntegrationAdapter beans.
 * Adapters self-register by being declared as @Component (or @Service) beans.
 * Hub uses this to look up the right adapter by IntegrationType at runtime.
 */
@Component
