...
/**
 * IntegrationAdapter for JIRA Cloud (REST API v3). Fetches issues as RequirementRecords and pushes
 * issue create/update/transition commands.
 */
@Component
public class JiraCloudAdapter
    implements IntegrationAdapter<RequirementRecord, JiraCloudAdapter.JiraCommand> {
