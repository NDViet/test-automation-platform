 ...
 *
 * <p>Maps work items to {@link RequirementRecord}s and handles Service Hook payloads. Credentials:
 * {@code connectionParams.pat} (+ {@code organization}, {@code project}, optional {@code
 * base_url}).
 */
@Component
