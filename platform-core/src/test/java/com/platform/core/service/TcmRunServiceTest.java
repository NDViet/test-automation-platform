...
class TcmRunServiceTest {
    ...
    void setUp() {
        ...
        service = new TcmRunService(runRepo, executionRepo, testCaseRepo, casePropertyRepo,
                executionPropertyRepo, environmentRepo, new PropertyMatrixService());
    ...
    void confirmedGate_rejectsNonApprovedCase() {
        ...
        assertThatThrownBy(() -> service.createRun(projectId, "Run", null, null,
                List.of(caseId), MatrixType.FULL, "tester"))
    ...
    void parametrizedCase_full_createsExecutionPerCombination() {
        ...
        TestRun run = service.createRun(projectId, "Matrix Run", "v1", null,
                List.of(caseId), MatrixType.FULL, "tester");
    ...
    void emptyCaseList_isRejected() {
        assertThatThrownBy(() -> service.createRun(projectId, "Run", null, null,
                List.of(), MatrixType.FULL, "tester"))
                .isInstanceOf(IllegalArgumentException.class);
    }
}
