...
/**
 * Central RBAC decision logic for the platform's four roles
 * (ORG_ADMIN, TEAM_ADMIN, TEAM_MEMBER, VIEWER).
 *
 * <p>This is the authorization core; enforcement points (Spring Security
 * {@code @PreAuthorize}, portal route guards) call into it. ORG_ADMIN is granted
 * org-wide (null team); team roles apply to a specific team.</p>
 */
@Service
