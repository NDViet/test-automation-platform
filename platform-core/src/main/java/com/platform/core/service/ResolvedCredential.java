...
/**
 * The effective credential for a (project, integrationType), after deep-merging ORG → TEAM →
 * PROJECT scopes. Secrets are decrypted and held in memory only.
 *
...
public record ResolvedCredential(
  ...
  public String toString() {
    return "ResolvedCredential[type="
        + integrationType
        + ", scope="
        + secretScope
        + ", hasSecret="
