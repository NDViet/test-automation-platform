...
@Repository
public interface PlatformTraceabilityEdgeRepository extends JpaRepository<PlatformTraceabilityEdge, UUID> {

    List<PlatformTraceabilityEdge> findByProjectIdAndFromIdAndFromTier(UUID projectId, UUID fromId, String fromTier);

    List<PlatformTraceabilityEdge> findByProjectIdAndToIdAndToTier(UUID projectId, UUID toId, String toTier);
    ...
    @Query("""
            ...
            """)
    List<PlatformTraceabilityEdge> findCoverageEdgesForRequirement(@Param("projectId") UUID projectId,
    ...
    @Query("""
            ...
            """)
    void deleteByProjectIdAndFromIdAndEdgeType(@Param("projectId") UUID projectId,
