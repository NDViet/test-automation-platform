...
public interface TiaEventRepository extends JpaRepository<TiaEvent, UUID> {
  ...
  @Query(
      ...
      """)
  List<TiaEvent> findByProjectIdSince(
  ...
  @Query(
      ...
      """)
  Double avgReductionPct(@Param("projectId") UUID projectId, @Param("from") Instant from);
  ...
  @Query(
      ...
      """)
  List<Object[]> countByRiskLevel(@Param("projectId") UUID projectId, @Param("from") Instant from);
  ...
  @Query(
      value =
          ...
          """,
      nativeQuery = true)
  List<Object[]> dailyStatsForProject(
      @Param("projectId") UUID projectId, @Param("from") Instant from);
}
