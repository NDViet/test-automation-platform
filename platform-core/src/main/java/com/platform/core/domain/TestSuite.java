...
public class TestSuite {
  ...
  public TestSuite(
      UUID projectId, String name, String description, UUID parentId, String planType) {
  ...
  public String getFilterIteration() {
  ...
  public boolean isSmart() {
    return "SMART".equalsIgnoreCase(selectionMode);
  }
