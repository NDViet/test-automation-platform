...
public class SotRelease {
  ...
  public String getMapIterationPath() {
    return mapIterationPath;
  }

  public String getMapAreaPath() {
    return mapAreaPath;
  }

  public UUID getMapTeamId() {
    return mapTeamId;
  }
  ...
  public boolean isMapped() {
    return mapIterationPath != null
        || mapAreaPath != null
        || mapTeamId != null
        || mapTag != null
        || (mappingField != null && mappingValue != null);
  }
  ...
  public void setReleaseType(String t) {
    this.releaseType = t != null ? t : "VERSION";
    this.updatedAt = Instant.now();
  }
  ...
  public void setExternalId(String e) {
    this.externalId = e;
    this.updatedAt = Instant.now();
  }
