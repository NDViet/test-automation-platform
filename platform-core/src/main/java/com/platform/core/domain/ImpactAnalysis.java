...
public class ImpactAnalysis {
    ...
    public List<Map<String, Object>> getLinkedPrs()     { return linkedPrs; }
    ...
    public void setLinkedPrs(List<Map<String, Object>> linkedPrs)               { this.linkedPrs = linkedPrs; }
    public void setLinkedRequirementIds(List<String> linkedRequirementIds)      { this.linkedRequirementIds = linkedRequirementIds; }
