...
public class PlatformTestCase {
  ...
  private String automationStatus =
      "NOT_STARTED"; // NOT_STARTED, GENERATING, PR_CREATED, PR_MERGED, FAILED
  ...
  public PlatformTestCase(
      UUID projectId, String title, List<String> acRefs, String createdBy, UUID agentSessionId) {
  ...
  public void markNeedsUpdate() {
    this.coverageStatus = "NEEDS_UPDATE";
    this.updatedAt = Instant.now();
  }

  public void markObsolete() {
    this.coverageStatus = "OBSOLETE";
    this.updatedAt = Instant.now();
  }

  public void markActive() {
    this.coverageStatus = "ACTIVE";
    this.updatedAt = Instant.now();
  }
  ...
  public void setHasAutomation(boolean v) {
    this.hasAutomation = v;
    this.updatedAt = Instant.now();
  }

  public void setAcRefs(List<String> v) {
    this.acRefs = v;
    this.updatedAt = Instant.now();
  }
  ...
  public UUID getSourceRequirementId() {
  ...
  public String getAutomationPrUrl() {
    return automationPrUrl;
  }

  public UUID getAutomationGithubConfigId() {
    return automationGithubConfigId;
  }

  public UUID getAutomationWorkflowId() {
    return automationWorkflowId;
  }
  ...
  public UUID getLastUpdatedByAnalysisId() {
    return lastUpdatedByAnalysisId;
  }
  ...
  public void unlinkRequirement(UUID requirementId) {
    ...
    String reqStr = requirementId.toString();
    this.linkedRequirementIds =
        this.linkedRequirementIds.stream()
