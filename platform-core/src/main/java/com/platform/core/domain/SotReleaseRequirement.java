...
public class SotReleaseRequirement {
  ...
  public java.util.UUID getReleaseId() {
    return releaseId;
  }

  public java.util.UUID getRequirementId() {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(releaseId, r.releaseId) && Objects.equals(requirementId, r.requirementId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(releaseId, requirementId);
  }
