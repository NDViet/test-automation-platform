 ...
 *
 * <p>The raw key is shown once at creation and never stored. Only the SHA-256 hash is persisted for
 * secure lookup.
 */
@Entity
@Table(
...
public class ApiKey {
  ...
  public static class Builder {
    ...
    public Builder keyHash(String v) {
      this.keyHash = v;
      return this;
    }

    public Builder keyPrefix(String v) {
      this.keyPrefix = v;
      return this;
    }
