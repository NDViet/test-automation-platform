...
/**
 * A parametrization property on a test case. Multiple rows with the same
 * {@code name} but different {@code value}s define the axis values that the
 * property matrix expands into per-combination executions.
 */
@Entity
