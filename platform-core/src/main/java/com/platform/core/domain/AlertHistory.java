...
/**
 * Persisted record of every alert event that was fired by the rule engine. Used for audit,
...
public class AlertHistory {
  ...
  public static class Builder {
    ...
    public Builder teamId(String v) {
      this.teamId = v;
      return this;
    }
    ...
    public Builder channels(String v) {
      this.channels = v;
      return this;
    }

    public Builder delivered(boolean v) {
      this.delivered = v;
      return this;
    }
