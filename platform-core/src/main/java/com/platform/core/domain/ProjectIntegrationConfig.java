...
@Entity
@Table(name = "project_integration_configs",
...
public class ProjectIntegrationConfig {
    ...
    public ProjectIntegrationConfig(UUID projectId, String tier, String integrationType,
                                     String displayName, String syncDirection) {
    ...
    public void recordSyncError() { this.consecutiveErrors++; }
    ...
    public Map<String, String> getFilterConfig()     { return filterConfig; }
    ...
    public void setConnectionParams(Map<String, String> m) { this.connectionParams = m; }
    public void setFieldMappings(Map<String, Object> m)    { this.fieldMappings = m; }
    public void setFilterConfig(Map<String, String> m)     { this.filterConfig = m; }
    public void setRepoType(String repoType) { this.repoType = repoType != null ? repoType : "GENERAL"; }
