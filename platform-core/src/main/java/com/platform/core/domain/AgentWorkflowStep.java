...
public class AgentWorkflowStep {
    ...
    public AgentWorkflowStep(UUID workflowId, UUID nodeId, String nodeType,
                              String taskType, int sequenceOrder) {
    ...
    public BigDecimal getCostCents() { return costCents; }
    ...
    public void setArtifactManifest(Map<String, Object> m) { this.artifactManifest = m; }
