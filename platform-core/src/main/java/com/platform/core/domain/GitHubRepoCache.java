...
public class GitHubRepoCache {
    ...
    public GitHubRepoCache(UUID credentialId, String fullName, String owner, String repoName,
                           boolean isPrivate, String defaultBranch, String htmlUrl, Instant syncedAt) {
