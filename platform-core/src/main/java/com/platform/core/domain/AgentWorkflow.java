...
public class AgentWorkflow {
    ...
    public AgentWorkflow(UUID projectId, String triggerType, String triggerSource,
                         Map<String, Object> triggerRef) {
    ...
    public void markFailed(String msg) { this.status = "FAILED"; this.errorMessage = msg; this.completedAt = Instant.now(); }
    public void markAwaitingReview() { this.status = "AWAITING_REVIEW"; }
