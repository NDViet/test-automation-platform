...
public class AgentTokenBudget {
  ...
  public boolean isInputExceeded() {
    return usedInputTokens >= maxInputTokens;
  }

  public boolean isOutputExceeded() {
    return usedOutputTokens >= maxOutputTokens;
  }

  public boolean isCostExceeded() {
    return usedCostCents.compareTo(maxCostCents) >= 0;
  }
  ...
  public long getUsedInputTokens() {
  ...
  public long getUsedOutputTokens() {
    return usedOutputTokens;
  }

  public BigDecimal getMaxCostCents() {
    return maxCostCents;
  }

  public BigDecimal getUsedCostCents() {
    return usedCostCents;
  }
  ...
  public void setHardLimit(boolean v) {
    this.hardLimit = v;
    this.updatedAt = Instant.now();
  }

  public void setMaxInputTokens(long v) {
    this.maxInputTokens = v;
    this.updatedAt = Instant.now();
  }

  public void setMaxOutputTokens(long v) {
    this.maxOutputTokens = v;
    this.updatedAt = Instant.now();
  }

  public void setMaxCostCents(BigDecimal v) {
    this.maxCostCents = v;
    this.updatedAt = Instant.now();
  }
