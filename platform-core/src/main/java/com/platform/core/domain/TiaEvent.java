 ...
 *
 * <p>One row per {@link com.platform.analytics.impact.TestImpactService#analyse} invocation. Used
 * by Grafana dashboards to trend reduction %, risk level distribution, and coverage effectiveness
 * over time.
 */
@Entity
...
public class TiaEvent {
  ...
  public int getSelectedTests() {
    return selectedTests;
  }

  public int getUncoveredClasses() {
