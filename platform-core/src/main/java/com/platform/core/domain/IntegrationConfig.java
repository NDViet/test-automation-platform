 ...
 *
 * <p>{@code configJson} holds tracker-specific fields such as {@code email}, {@code apiToken},
 * {@code minConsecutiveFailures}, {@code flakinessThreshold}, {@code doneTransitionName}, etc.
 */
@Entity
@Table(
