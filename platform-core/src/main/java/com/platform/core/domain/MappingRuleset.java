...
/**
 * A persisted mapping-rule override for the Mapping Suggester, scoped to an organization or a
 * project. Resolution precedence (most specific wins): <b>PROJECT → ORG → built-in default
 * file</b>. Deleting the row "resets to default" (resolution falls back to the parent scope).
 */
@Entity
@Table(
    name = "mapping_rulesets",
    uniqueConstraints =
        @UniqueConstraint(
            name = "uq_mapping_ruleset_scope",
