...
/**
 * A baseline snapshot of an upstream work-item-type schema, used for drift detection. Comparing the
 * current live schema against this baseline yields removed/added/ type-changed fields and
 * state-category changes. Re-capturing = accept current schema.
 */
@Entity
@Table(
    name = "integration_schema_snapshots",
    uniqueConstraints =
        @UniqueConstraint(
            name = "uq_schema_snapshot",
...
public class IntegrationSchemaSnapshot {
  ...
  public IntegrationSchemaSnapshot(
      UUID projectId,
      String integrationType,
      String adoProject,
      String workItemType,
      String fieldsJson,
      String stateCategoriesJson,
      String fingerprint,
      String capturedBy) {
  ...
  public String getStateCategoriesJson() {
    return stateCategoriesJson;
  }
  ...
  public void update(
      String fieldsJson, String stateCategoriesJson, String fingerprint, String capturedBy) {
    this.fieldsJson = fieldsJson;
    this.stateCategoriesJson = stateCategoriesJson;
    this.fingerprint = fingerprint;
    this.capturedBy = capturedBy;
