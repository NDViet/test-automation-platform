...
/**
 * Aggregated performance metrics for a single test execution produced by K6, Gatling, or JMeter.
 *
 * <p>One row per {@link TestExecution} — enforced by the unique constraint on {@code execution_id}.
 */
@Entity
