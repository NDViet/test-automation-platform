...
public class FlakinessScore {
  ...
  public static class Builder {
    ...
    public Builder score(BigDecimal v) {
      this.score = v;
      return this;
    }

    public Builder classification(Classification v) {
      this.classification = v;
      return this;
    }

    public Builder totalRuns(int v) {
      this.totalRuns = v;
      return this;
    }

    public Builder failureCount(int v) {
      this.failureCount = v;
      return this;
    }

    public Builder failureRate(BigDecimal v) {
      this.failureRate = v;
      return this;
    }
    ...
    public Builder lastPassedAt(Instant v) {
      this.lastPassedAt = v;
      return this;
    }

    public FlakinessScore build() {
      return new FlakinessScore(this);
    }
  }
}
