...
/**
 * Immutable audit trail record for security-sensitive and operationally important platform events.
 *
 * <p>Event types: INGEST, API_KEY_CREATED, API_KEY_REVOKED, TICKET_CREATED, TICKET_CLOSED,
 * ANALYSIS_TRIGGERED, QUALITY_GATE_FAILED.
 */
@Entity
@Table(
    name = "audit_events",
...
public class AuditEvent {
  ...
  public String getActorKeyPrefix() {
    return actorKeyPrefix;
  }
  ...
  public static class Builder {
    ...
    public Builder actorKeyId(UUID v) {
      this.actorKeyId = v;
      return this;
    }

    public Builder actorKeyPrefix(String v) {
      this.actorKeyPrefix = v;
      return this;
    }

    public Builder teamId(UUID v) {
      this.teamId = v;
      return this;
    }

    public Builder resourceType(String v) {
      this.resourceType = v;
      return this;
    }
