...
/**
 * An RBAC role assignment. A null {@code teamId} denotes an organization-wide role ({@code
 * ORG_ADMIN} or org {@code VIEWER}); otherwise the role applies to the referenced team.
 */
@Entity
