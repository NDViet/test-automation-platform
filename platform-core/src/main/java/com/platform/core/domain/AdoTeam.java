...
public class AdoTeam {
  ...
  @Column(name = "ado_id", nullable = false)
  ...
  public String getDefaultAreaPath() {
    return defaultAreaPath;
  }

  public List<String> getAreaPaths() {
    return areaPaths;
  }
  ...
  public void setDefaultAreaPath(String v) {
    this.defaultAreaPath = v;
  }

  public void setAreaPaths(List<String> v) {
    this.areaPaths = v != null ? v : new java.util.ArrayList<>();
  }
