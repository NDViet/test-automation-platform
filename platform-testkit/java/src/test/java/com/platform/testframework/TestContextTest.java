...
class TestContextTest {
  ...
  void pushPopStepBuildsRootSteps() {
    TestContext ctx =
        new TestContext(
            "id", "display", "ClassName", "method", List.of(), "trace-1", "team", "proj");
  ...
  void nestedStepsAreChildrenOfParent() {
    TestContext ctx =
        new TestContext(
            "id", "display", "ClassName", "method", List.of(), "trace-2", "team", "proj");
  ...
  void environmentAndAttachmentsArePreserved() {
    TestContext ctx =
        new TestContext(
            "id", "display", "ClassName", "method", List.of(), "trace-3", "team", "proj");
  ...
  void snapshotClosesAllOpenSteps() {
    TestContext ctx =
        new TestContext(
            "id", "display", "ClassName", "method", List.of(), "trace-4", "team", "proj");
