...
class StepNameResolverTest {
  ...
  void interpolate_singleParam() {
    String result =
        StepNameResolver.interpolate(
            "Submit payment with {cardType}", new String[] {"cardType"}, new Object[] {"Visa"});
  ...
  void interpolate_nullArgRenderedAsNull() {
    String result =
        StepNameResolver.interpolate("Fill {field}", new String[] {"field"}, new Object[] {null});
  ...
  void interpolate_unmatchedPlaceholderLeftAsIs() {
    String result =
        StepNameResolver.interpolate(
            "Navigate to {url}", new String[] {"page"}, new Object[] {"home"});
  ...
  void resolve_explicitTemplateNoParams_usedAsIs() {
    String result = StepNameResolver.resolve("Open the home page", "openHomePage", null, null);
