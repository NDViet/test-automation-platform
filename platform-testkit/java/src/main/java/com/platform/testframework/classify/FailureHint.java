 ...
 *
 * <p>Attached to each test result as environment entries so the platform AI classifier and
 * dashboard can surface it without re-analyzing the exception.
 *
 ...
 */
public record FailureHint(FailureCategory category, double confidence, String message) {
