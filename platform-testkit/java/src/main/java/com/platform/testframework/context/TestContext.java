 ...
 *
 * <p>Holds the running state of a single test execution: identity, timing, accumulated steps,
 * attachments, and trace correlation. The {@link #snapshot()} method produces an immutable view for
 * publishing after the test completes.
 *
 * <p>Nested steps are tracked as a stack — {@link #pushStep} / {@link #popStep} allow
 * keyword-driven and page-object helpers to open child steps transparently.
 */
