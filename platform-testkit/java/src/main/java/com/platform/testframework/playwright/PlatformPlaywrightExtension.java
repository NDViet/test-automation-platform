...
/**
 * JUnit5 {@code @RegisterExtension} that manages the full Playwright browser lifecycle and
 * integrates with the platform framework.
 *
 * <h3>What it does:</h3>
 *
 * <ul>
 *   <li>Creates a Playwright instance, browser, and context before each test
 *   <li>Attaches {@link PlatformPlaywrightSupport} listeners (console errors, network failures,
 *       page errors) to every page
 *   <li>Auto-captures a full-page screenshot on test failure
 *   <li>Closes browser/playwright cleanly after each test
 * </ul>
 *
...
public class PlatformPlaywrightExtension
  ...
  public void beforeEach(ExtensionContext ctx) {
    ...
    com.microsoft.playwright.BrowserType.LaunchOptions opts =
