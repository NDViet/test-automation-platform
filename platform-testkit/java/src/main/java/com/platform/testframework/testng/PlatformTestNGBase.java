 ...
 *
 * <p>Pre-wires {@link PlatformTestNGListener} so subclasses just extend this and get structured
 * logging, tracing, step tracking, and platform publishing automatically.
 *
 * <h3>Example:</h3>
 *
 * <pre>{@code
...
public abstract class PlatformTestNGBase {
  ...
  /**
   * Adds a custom environment key-value (browser version, device, base URL, etc.) to the test
   * result sent to the platform.
   */
