...
public class PortalAutomatedTestController {
    ...
    public Object list(
        ...
        UriComponentsBuilder builder = UriComponentsBuilder
                .fromPath("/api/v1/analytics/{projectId}/automated-tests")
        ...
        if (annotationTypes != null) annotationTypes.forEach(a -> builder.queryParam("annotationTypes", a));
    ...
    @GetMapping("/browsers")
    @Operation(summary = "Distinct Playwright project names (browsers/devices) within the time window")
    ...
    public Object labelValues(
        ...
        String uri = UriComponentsBuilder
                .fromPath("/api/v1/analytics/{projectId}/automated-tests/label-values")
                .queryParam("days", days)
    ...
    public Object detail(
            ...
            @RequestParam(defaultValue = "30") int days) {
        String uri = UriComponentsBuilder
                .fromPath("/api/v1/analytics/{projectId}/automated-tests/detail")
    ...
    private String discoveryUri(String projectId, String segment, int days) {
        return UriComponentsBuilder
                .fromPath("/api/v1/analytics/{projectId}/automated-tests/" + segment)
                .queryParam("days", days)
                .buildAndExpand(projectId)
                .toUriString();
    }
