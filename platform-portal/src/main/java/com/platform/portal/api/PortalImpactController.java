 ...
 *
 * GET  /api/portal/projects/{projectId}/impact-analyses        → GET  /hub/impact/{projectId}
 * POST /api/portal/projects/{projectId}/impact-analyses        → POST /hub/impact/{projectId}
 * GET  /api/portal/projects/{projectId}/impact-analyses/prs    → GET  /hub/impact/{projectId}/prs
 * GET  /api/portal/projects/{projectId}/impact-analyses/{id}   → GET  /hub/impact/{projectId}/{id}
 */
@RestController
