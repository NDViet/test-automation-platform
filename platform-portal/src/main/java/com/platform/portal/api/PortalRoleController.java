...
/**
 * BFF proxy for RBAC role administration. Forwards the {@code X-Actor} header
 * (the acting user) so platform-ingestion can enforce authorization.
 */
@RestController
...
public class PortalRoleController {
    ...
    @PostMapping
    public Object grant(@RequestHeader(value = "X-Actor", required = false) String actor,
