...
public class PortalProjectManagementController {
  ...
  public ResponseEntity<Void> deleteOrganization(@PathVariable String id) {
    ingestionClient.delete().uri("/api/v1/organizations/" + id).retrieve().toBodilessEntity();
  ...
  public ResponseEntity<Object> createTeam(
      @PathVariable String projectId, @RequestBody Object body) {
    Object result =
        ingestionClient
            .post()
            .uri("/api/v1/projects/" + projectId + "/teams")
  ...
  public ResponseEntity<Void> deleteProject(@PathVariable String id) {
    ingestionClient.delete().uri("/api/v1/projects/" + id).retrieve().toBodilessEntity();
    return ResponseEntity.noContent().build();
  }
  ...
  public ResponseEntity<Void> deleteIntegration(
      @PathVariable String id, @PathVariable String configId) {
    ingestionClient
        .delete()
