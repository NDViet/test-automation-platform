 ...
 *
 * <p>GET /api/portal/projects/{projectId}/work-items → GET /hub/wip/{projectId} POST
 * /api/portal/projects/{projectId}/work-items/review-requests/{requestId}/approve → POST
 * /hub/wip/review-requests/{requestId}/approve POST
 * /api/portal/projects/{projectId}/work-items/review-requests/{requestId}/reject → POST
 * /hub/wip/review-requests/{requestId}/reject
 */
@RestController
...
public class PortalWorkItemController {
  ...
  public Object list(@PathVariable String projectId) {
    try {
      return agentClient.get().uri("/hub/wip/" + projectId).retrieve().body(List.class);
