...
public class PortalRequirementController {
  ...
  public Object pageRequirements(
    ...
    StringBuilder uri =
        new StringBuilder("/api/v1/projects/" + projectId + "/requirements/page")
            .append("?page=")
            .append(page)
            .append("&size=")
            .append(size);
  ...
  public Object getRequirementRelations(
      @PathVariable String projectId, @PathVariable String reqId) {
    return ingestionClient
        .get()
  ...
  public Object productivityWipItems(
      @PathVariable String projectId,
      @RequestParam(required = false) String area,
    ...
    return ingestionClient
        ...
        .uri(
            b -> {
              var u =
                  b.path("/api/v1/projects/" + projectId + "/productivity/wip-items")
                      .queryParam("over", over);
              if (area != null) u.queryParam("area", area);
              return u.build();
            })
        .accept(MediaType.APPLICATION_JSON)
        .retrieve()
  ...
  public Object productivityLeadItems(
      @PathVariable String projectId, @RequestParam(required = false) String area) {
    return ingestionClient
        .get()
        .uri(
            b -> {
              var u = b.path("/api/v1/projects/" + projectId + "/productivity/lead-items");
              if (area != null) u.queryParam("area", area);
              return u.build();
            })
        .accept(MediaType.APPLICATION_JSON)
  ...
  public Object setProductivityThreshold(
  ...
  public Object prAnalyses(
      @PathVariable String projectId, @RequestParam(defaultValue = "30") int limit) {
    try {
      return agentClient
          .get()
