...
/**
 * Portal BFF — flaky test management. POST /api/portal/projects/{projectId}/flakiness/recompute —
 * trigger score recomputation POST /api/portal/projects/{projectId}/flakiness/fix — trigger AI fix
 * (→ HealingNode)
 */
@RestController
...
public class PortalFlakyController {
  ...
  @PostMapping("/fix")
  public Object triggerFix(@PathVariable String projectId, @RequestBody Map<String, Object> body) {
    return agentClient
        .post()
