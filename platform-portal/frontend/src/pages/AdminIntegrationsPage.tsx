    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">
          Centralized credentials (Admin PAT) that projects and teams inherit. Secrets are encrypted
          at rest and resolved by precedence <strong>Team → Project → Organization</strong>.
        </p>
      </div>
