...
public class AutomatedTestController {
  ...
  @GetMapping("/browsers")
  @Operation(
      summary = "Distinct Playwright project names (browsers/devices) seen within the time window")
  ...
  @Operation(
      summary = "Distinct annotation types (fixme, slow, fail, …) seen within the time window")
