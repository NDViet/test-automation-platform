...
public record AutomatedTestSummaryDto(
    ...
    /**
     * Spec file path relative to the project root, e.g. "tests/checkout/payment.spec.ts". Null for
     * tests ingested before V13.
     */
    String specFile,
    ...
    /**
     * Per-label-key, the distinct values seen across all results in the window. e.g. {"owner":
     * ["alice", "bob"], "jira": ["PROJ-123"]}
     */
