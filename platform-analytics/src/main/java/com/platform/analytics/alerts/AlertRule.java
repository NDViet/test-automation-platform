 ...
 *
 * <p>Rules are loaded from {@code application.yml} under {@code platform.analytics.alerts.rules}.
 */
public record AlertRule(
    String name, Metric metric, double threshold, Severity severity, boolean enabled) {
  public enum Metric {
