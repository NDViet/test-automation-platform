...
public class AlertProperties {
  ...
  /**
   * Optional generic webhook URL. Receives a JSON POST with the same payload as the Slack message —
   * useful for custom integrations (PagerDuty, Teams, etc.)
   */
  ...
  public void setRules(List<AlertRule> v) {
    this.rules = v;
  }
}
