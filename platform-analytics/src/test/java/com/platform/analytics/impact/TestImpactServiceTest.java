...
class TestImpactServiceTest {
  ...
  void filePathToClassName_windowsPaths() {
    assertThat(TestImpactService.filePathToClassName("src\\main\\java\\com\\example\\Foo.java"))
  ...
  void filePathToClassName_unknownExtension() {
    ...
    assertThat(TestImpactService.filePathToClassName("docs/README.md")).isEqualTo("docs.README");
  }
}
