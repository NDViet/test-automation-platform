...
public class ResultIngestionController {
  ...
  @Operation(
      ...
      description =
          "Accepts raw test report files (JUnit XML, Cucumber JSON, TestNG, Allure, Playwright,"
              + " Newman) and normalizes them into the platform. Returns a runId for tracking.")
