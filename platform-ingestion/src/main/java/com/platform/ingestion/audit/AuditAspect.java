...
/**
 * AOP aspect that intercepts {@link AuditLog}-annotated methods and persists an {@link AuditEvent}
 * for each invocation.
 *
 * <p>Runs around the method: records SUCCESS on normal return, FAILURE on exception.
 */
@Aspect
@Component
