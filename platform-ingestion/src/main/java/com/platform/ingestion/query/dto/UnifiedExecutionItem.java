...
/**
 * A single row in the unified Test Execution list — covers both manual TestRuns and automated CI
 * TestExecutions. Discriminated by {@code type}.
 */
public record UnifiedExecutionItem(
    ...
    String ciRunUrl,
    /**
     * Navigation key: for MANUAL = TestRun UUID string; for AUTOMATED = CI run ID. Frontend uses
     * this to build the detail URL.
     */
    String runId,
    Instant date) {}
