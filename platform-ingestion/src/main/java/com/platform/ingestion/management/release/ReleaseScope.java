...
/**
 * Builds the SQL predicate that selects the requirements making up a release's scope, AND-combining
 * every mapping dimension the release sets. Requirements table must be aliased {@code r}. Adds the
 * needed bind values to the given parameter source.
 */
