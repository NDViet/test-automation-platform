...
public class ProjectGitHubService {
  ...
  public ProjectGitHubService(
      ProjectRepoAssignmentRepository assignmentRepo, GitHubRepoCacheRepository cacheRepo) {
  ...
  public List<AssignmentDto> setAssignments(UUID projectId, List<SaveDto> dtos) {
    ...
    if (dtos != null) {
      ...
      for (SaveDto dto : dtos) {
        ...
        toSave.add(
            new ProjectRepoAssignment(
                projectId, UUID.fromString(dto.credentialId()), dto.repoFullName(), dto.role()));
      }
