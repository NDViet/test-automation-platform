...
/**
 * A credential a project inherits from a higher scope (Organization / Team). Surfaced read-only in
 * Project → Settings → Integrations so a project sees what it already gets for free and only
 * overrides what it needs. Never carries the secret.
 *
