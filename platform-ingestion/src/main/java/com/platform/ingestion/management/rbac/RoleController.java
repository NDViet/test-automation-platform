...
/**
 * RBAC role administration. The {@code X-Actor} header identifies the calling user; authorization
 * is enforced in {@link RoleService} via {@code RbacService}.
 */
@RestController
...
public class RoleController {
  ...
  public ResponseEntity<Void> revoke(
      @RequestHeader(value = "X-Actor", required = false) String actor, @PathVariable UUID id) {
