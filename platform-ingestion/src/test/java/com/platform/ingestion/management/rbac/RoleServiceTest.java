...
class RoleServiceTest {
    ...
    void bootstrap_allowsFirstOrgAdmin_withoutPermission() {
        ...
        TeamMemberDto dto = service.grant("anyone",
                new GrantRoleRequest("alice", "ORG", null, "ORG_ADMIN"));
    ...
    void nonAdmin_cannotGrantOrgRole() {
        ...
        assertThatThrownBy(() -> service.grant("bob",
                new GrantRoleRequest("carol", "ORG", null, "VIEWER")))
    ...
    void teamAdmin_canGrantTeamRole() {
        ...
        TeamMemberDto dto = service.grant("lead",
                new GrantRoleRequest("dev", "TEAM", teamId, "TEAM_MEMBER"));
