...
class MappingSuggesterTest {
  ...
  void routesLanesFromTypeNames() {
    ...
    assertThat(s.suggestLane(defaults, "Acme Team Epic"))
        .isEqualTo(new MappingSuggester.Lane("REQUIREMENT", "EPIC"));
  ...
  void suggestsDefectProfileForCustomBug() {
    var fields =
        List.of(
            ...
            new MappingSuggester.Field(
                "Acme.AffectedVersion", "Acme Affected versions", true, false),
    ...
    Map<String, Object> p =
        s.suggest(
            ...
            "Acme Bug",
            fields,
            List.of("Proposed", "InProgress", "Completed", "Removed"),
            true);
    ...
    assertThat(fieldMap)
        .containsEntry("System.Title", "title")
  ...
  void suggestsRequirementProfileWithParent() {
    ...
    Map<String, Object> p =
        s.suggest(
            ...
            "Acme PRQ",
            fields,
            List.of("Proposed", "InProgress", "Completed"),
            false);
    Map<String, Object> spec = (Map<String, Object>) p.get("spec");
    assertThat(spec.get("lane")).isEqualTo("REQUIREMENT");
    assertThat(spec.get("issueType")).isEqualTo("REQUIREMENT");
    assertThat((Map<String, String>) spec.get("fieldMap"))
        .containsEntry("System.Parent", "parentExternalId");
