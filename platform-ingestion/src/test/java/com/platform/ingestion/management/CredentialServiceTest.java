...
class CredentialServiceTest {
  ...
  void save_encryptsSecret_andDoesNotReturnIt() {
    ...
    ArgumentCaptor<IntegrationCredential> cap =
  ...
  void update_withoutSecret_keepsExistingCiphertext() {
    ...
    IntegrationCredential existing =
        new IntegrationCredential(
            IntegrationCredential.Scope.ORG,
            orgId,
            "GITHUB_ISSUES",
            "GH",
            "https://api.github.com",
            new java.util.HashMap<>(Map.of("owner", "acme")),
            existingCt);
    ...
    SaveCredentialRequest req =
        new SaveCredentialRequest(
            ...
            "GH renamed",
            "https://api.github.com",
            Map.of("owner", "acme", "repo", "checkout"),
            null,
            true,
            null);
  ...
  void testConnection_decryptsSecretIntoParams() {
    ...
    IntegrationCredential c =
        new IntegrationCredential(
            ...
            "ADO",
            "https://dev.azure.com",
            new java.util.HashMap<>(Map.of("organization", "acme")),
            ct);
    ...
    verify(healthChecker)
        .check(eq("AZURE_DEVOPS_BOARDS"), eq("https://dev.azure.com"), params.capture());
    assertThat(params.getValue())
        .containsEntry("organization", "acme")
        .containsEntry("pat", "P123");
  }
