 ...
 *
 * <p>Register alongside the standard JSON formatter in your runner or CLI options:
 *
 * <pre>{@code
 ...
 * }</pre>
 *
 * <p>The plugin reads JSON files from {@code target/cucumber-reports} (or the directory specified
 * by {@code PLATFORM_REPORT_DIR}) after the run completes.
 */
